...
This is the standalone, hardened, distributable version — same state machine, same edge case handling, with a 3-layer TOML config, a zero-dependency installer, dry-run mode, and full resume semantics.
